...
@WebFluxTest(controllers = {TopupController.class})
public class TopupControllerTest {
    ...
    public void givenId_whenGetTransaction_thenTransactionIsReturned() {
        ...
        result.expectStatus().isOk()
                ...
                .jsonPath("$.transaction_id").isEqualTo("transactionDtoId")
    ...
    public void givenIncorrectId_whenGetTransaction_thenExceptionIsReturned() {
        ...
        //when
        WebTestClient.ResponseSpec result = webTestClient.get()
                .uri("/api/v1/payments/transaction/1/details")
                .exchange();
    ...
    public void givenDtoInput_whenCreate_thentransactionDtoOutIsReturned() {
        ...
        BDDMockito.given(transactionService.createTopup(any(TransactionDtoInput.class), any(ServerWebExchange.class)))
    ...
    public void givenIncorrectDtoInput_whenCreate_thenExceptionIsReturned() {
        ...
        BDDMockito.given(transactionService.createTopup(any(TransactionDtoInput.class), any(ServerWebExchange.class))) //TODO ServerWebExchange where from?
                .willThrow(new TransactionFailedException("Account is not found", "TOPUP_FAILED"));
